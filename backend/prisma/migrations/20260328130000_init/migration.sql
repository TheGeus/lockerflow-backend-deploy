-- Initial Prisma migration for gestionlocker MVP
...
CREATE INDEX "idx_packages_person_id" ON "packages"("person_id");
CREATE INDEX "idx_pickup_codes_expires_at" ON "pickup_codes"("expires_at");
CREATE INDEX "idx_overflow_items_status" ON "overflow_items"("status");
